class SongSheetModel {
  ...
  SongSheetModel.fromJson(Map<String, dynamic> json) {
    _code = json['code'];
    ...
    Map<String, dynamic> toJson() {
      ...
      if (this.playlists != null) {
        data['playlist'] = this.playlists.map((v) => v.toJson()).toList();
      }
      return data;
    }
  }
...
class PlayListData {
  ...
  PlayListData.fromJson(Map<String, dynamic> json) {
    ...
    _playlist = json['playlist'] != null ? new Playlist.fromJson(json['playlist']) : null;
  }
...
class Playlist {
  ...
  set backgroundCoverId(num backgroundCoverId) => _backgroundCoverId = backgroundCoverId;
  ...
  set subscribedCount(num subscribedCount) => _subscribedCount = subscribedCount;
  num get cloudTrackCount => _cloudTrackCount;
  set cloudTrackCount(num cloudTrackCount) => _cloudTrackCount = cloudTrackCount;
  ...
  set trackUpdateTime(num trackUpdateTime) => _trackUpdateTime = trackUpdateTime;
  ...
  set commentThreadId(String commentThreadId) => _commentThreadId = commentThreadId;
  ...
  Playlist.fromJson(Map<String, dynamic> json) {
    ...
    _creator = json['creator'] != null ? new Subscribers.fromJson(json['creator']) : null;
    if (json['tracks'] != null) {
...
class Subscribers {
  ...
  set backgroundImgId(num backgroundImgId) => _backgroundImgId = backgroundImgId;
